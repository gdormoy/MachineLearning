...
extern "C"{
    ...
    DLLEXPORT double* train_linear_class_model(double* model, double* dataset, double* expected_output){

    }
    // create matrixXd with size + 1 col
    // transpose
    // transpose dataset and create vector1 (bias)
    // add both and transpose
    // regression training in one shot
